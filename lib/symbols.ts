...
export const EXTRA_SYMBOLS = [
  "ASML","BABA","BIDU","BYND","CHWY","COIN","DOCU","EBAY","LCID","LYFT",
  "NIO","NTES","OKTA","PLUG","PINS","ROKU","SNOW","SPOT","SQ","SOFI",
  "UBER","TWLO","ZM","ZS","MDB","CRWD","DDOG","RBLX","FVRR","PTON",
  "PLTR","SHOP","RIVN","BILI","AMC","GME","TCEHY","JD","PDD","AFRM",
  "UPST","FTNT","NET","TEAM","NOW","SNAP","ZNGA","YETI","MARA","MSTR"
];
...
export const MARKET_SYMBOLS = Array.from(new Set([...SP500_SYMBOLS, ...EXTRA_SYMBOLS]));
